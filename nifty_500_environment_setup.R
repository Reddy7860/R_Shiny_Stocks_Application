...
setwd("~/Desktop/Reddy_Stocks_Application")
nse_data <- read.csv(paste0(getwd(),"/data/ind_nifty500list.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/nifty_500_cowboy_data.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/nifty_500_reds_rocket.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/nifty_500_reds_brahmos.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/nifty_500_blackout.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/nifty_500_gaps_strategy.csv"))
